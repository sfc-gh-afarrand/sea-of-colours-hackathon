> ### This directory is yours — EMEA_TECHUP_AFARRAND
>
...
```44:75:sea_of_colours/orchestrator_2/harnesses/emea_techup_afarrand/orbit_policy.py
...
```43:43:sea_of_colours/orchestrator_2/harnesses/emea_techup_afarrand/_v7/chat_schema.py
...
Prefer changing `emea_techup_afarrand/` proper; touch `_v7/` only for shared
...
| --- | --- | --- |
| `EMEA_TECHUP_AFARRAND_SINGLE` | `0` | `1` skips the THINK/PLAN split — one LLM call, faster, dumber |
| `EMEA_TECHUP_AFARRAND_AUTOFILL` | `0` | `1` lets the packager top up a short plan |
