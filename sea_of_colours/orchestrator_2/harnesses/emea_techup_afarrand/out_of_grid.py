"""emea_techup_afarrand — OUT-OF-GRID KNOWLEDGE: what you can SENSE but cannot SEE.
...
from sea_of_colours.orchestrator_2.harnesses.emea_techup_afarrand.world_view import (
    _live_rows,
    _my_probe_cells,
    _tier,
)
